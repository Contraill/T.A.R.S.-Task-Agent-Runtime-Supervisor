...
Default policy permits scoped reads, asks for writes, execution, public network access, service changes, remote access, secret use and destructive operations, and denies elevation and sandbox escape. Explicit rules may narrow or override these defaults.
